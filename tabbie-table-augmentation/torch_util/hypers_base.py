...
import os
import socket
from torch_util.args_help import fill_from_args, fill_from_dict, name_value_list
import json
import time
import random
import numpy as np
...
class HypersBase:
    ...
    def __init__(self):
        ...
        self.learning_rate = 1e-5 # As per standard from TABBIE for column population task
        ...
        self.full_train_batch_size = 12  # previous default was 32. As per standard from TABBIE for column population task
