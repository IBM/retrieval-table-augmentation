...
class Distribution:
    def __init__(self, thresholds: Iterable[float], *, num_samples_per_threshold=5):
        """
        Track summary statistics on the distribution of some scalar
        @param thresholds: for each threshold we count the number of values that are less than or equal to it
        @param num_samples_per_threshold: we will record this many samples of values for each threshold
        """
